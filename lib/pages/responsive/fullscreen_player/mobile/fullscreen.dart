...
class MobileFullscreenPlayerPage extends ConsumerStatefulWidget {
  ...
  @override
  _MobileFullscreenPlayerPageState createState() =>
      _MobileFullscreenPlayerPageState();
}

class _MobileFullscreenPlayerPageState
    extends ConsumerState<MobileFullscreenPlayerPage> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: horizPadding),
            child: MarqueeTextWidget(
              text: "${player.albumDisplayName} - ${player.artistDisplayName}",
              ...
              child: Column(
                children: [
                  SliderTheme(
                    ...
                    child: Slider(
                      value:
                          player.duration == 0 ? 0 : player.position.toDouble(),
                      onChanged: (value) => ref
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(millisecondsToDurationString(player.position),
                        ...
                        Text(millisecondsToDurationString(player.duration),
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium!
                                .copyWith(
              ...
              children: [
                ...
                Expanded(
                  child: SliderTheme(
                    ...
                    child: Slider(
                      value: player.volume,
                      onChanged: (value) => ref.read(playerProvider.notifier).setVolume(value),
                      // onChanged: (value) {},
                      // onChanged: (value) => ref
                      //     .read(playerProvider.notifier)
                      //     .seek(Duration(milliseconds: value.toInt())),

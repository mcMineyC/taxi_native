...
class BrightnessModeSwitch extends StatefulWidget {
  ...
  @override
  State<BrightnessModeSwitch> createState() => _BrightnessModeSwitchState();
}

class _BrightnessModeSwitchState extends State<BrightnessModeSwitch> {
  bool init = false;
...
class ColorSourceModeSwitch extends StatefulWidget {
  Function(ColorSourceMode) onSelected;
  ColorSourceMode mode;
  ColorSourceModeSwitch({required this.onSelected, required this.mode});

  @override
  _ColorSourceModeSwitchState createState() => _ColorSourceModeSwitchState();
}

class _ColorSourceModeSwitchState extends State<ColorSourceModeSwitch> {
  bool init = false;
